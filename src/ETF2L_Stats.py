...
class CanvasPanel(wx.Panel):
    ...
    def plot_progress(self,playerID):
        ...
        if playerID not in loadedPlayers.keys():
            ...
            status = "Player Info For " + loadedPlayers[playerID].playerName + " (" + str(playerID) + ") Already Downloaded"
            print(status)
        ...
        #Plot the graph
        self.ax.clear()
        self.ax.scatter(progressData['time'][progressData['impact'] > 0],progressData['div'][progressData['impact'] > 0], s=progressData['impact'][progressData['impact'] > 0], alpha = 0.6, marker='o',c="Blue")
        self.ax.scatter(progressData['time'][progressData['impact'] == 0 ],progressData['div'][progressData['impact'] == 0], s=50, alpha = 0.6, marker='x',c="Red")
